package com.springboot.disruptor.producer;

import com.lmax.disruptor.*;
import com.lmax.disruptor.dsl.Disruptor;
import com.lmax.disruptor.dsl.EventHandlerGroup;
import com.lmax.disruptor.dsl.ProducerType;
import com.springboot.disruptor.consumer.AmountTrasfer;
import com.springboot.disruptor.consumer.InnerDBHandler;
import com.springboot.disruptor.consumer.SendMsgHandler;
import com.springboot.disruptor.consumer.TransHandler;
...
public class TransactionEventProducer implements Runnable{
    ...
    public void run() {
        try {
            //Event对象初始化类
            AmountTrasfer th = new AmountTrasfer();
            //发布事件
    ...
    public void disruptorManage() throws Exception{
        ...
        eventsWith.then((event, sequence, endOfBatch)->{
